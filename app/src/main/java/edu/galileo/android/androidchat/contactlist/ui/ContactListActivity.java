...
import edu.galileo.android.androidchat.util.DividerItemDecoration;
...
public class ContactListActivity extends AppCompatActivity implements ContactListView, OnItemClickListener {
    ...
    private void setupInjection() {
        ...
        application.getContactListComponent(this, this, this).inject(this);
    }
    ...
    private void setupRecyclerView() {
        ...
        recyclerViewContacts.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL_LIST));
        recyclerViewContacts.setHasFixedSize(true); // allows for optimizations if all items are of the same size
